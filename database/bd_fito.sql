...
CREATE TABLE IF NOT EXISTS `bd_fito`.`colaboradores` (
  ...
  `grupos_id` INT ZEROFILL NOT NULL COMMENT 'Estrangeira de grupos.',
  `status` TINYINT(1) NOT NULL COMMENT 'Status do colaborador:\n0 - Ativo\n1 - Desativado',
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC),
  UNIQUE INDEX `cpf_UNIQUE` (`cpf` ASC),
  INDEX `fk_colaboradores_grupos1_idx` (`grupos_id` ASC),
  CONSTRAINT `fk_colaboradores_grupos1`
...
CREATE TABLE IF NOT EXISTS `bd_fito`.`colaboradores_has_campanhas` (
  `colaboradores_id` INT ZEROFILL NOT NULL COMMENT 'Estrangeira de colaboradores.',
  `campanhas_id` INT ZEROFILL NOT NULL COMMENT 'Estrangeira de campanhas.',
  ...
  PRIMARY KEY (`colaboradores_id`, `campanhas_id`),
